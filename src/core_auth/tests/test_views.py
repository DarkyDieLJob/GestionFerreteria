...
class TestLoginView(TestCase):
    ...
    def test_login_validation_error(self, MockLoginUseCase):
        ...
        MockLoginUseCase.return_value.execute.side_effect = ValidationError(
    ...
    def test_login_generic_exception(self, MockLoginUseCase):
        ...
        MockLoginUseCase.return_value.execute.side_effect = Exception(
            "Unexpected error"
        )
        response = self.client.post(
...
class TestRegisterView(TestCase):
    ...
    def test_register_successful(self):
        ...
        self.assertEqual(len(messages), 1)
        self.assertEqual(
            str(messages[0]), "¡Registro exitoso! Por favor, inicia sesión."
        )
