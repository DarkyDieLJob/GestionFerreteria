...
class TestRegisterUserUseCase(TestCase):
    ...
    def test_register_user_duplicate_username(self):
        ...
        self.mock_repository.create_user.side_effect = Exception('User with this username already exists')
    ...
    def test_register_user_duplicate_email(self):
        ...
        self.mock_repository.create_user.side_effect = Exception('User with this email already exists')
    ...
    def test_register_user_generic_exception(self):
        ...
        self.mock_repository.create_user.side_effect = Exception('Database connection error')
...
class TestLoginUserUseCase(TestCase):
    ...
    def test_login_auth_service_error(self):
        ...
        self.mock_repository.authenticate_user.side_effect = Exception('Authentication service unavailable')
