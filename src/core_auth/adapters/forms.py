...
class EnforcedPasswordChangeForm(DjangoPasswordChangeForm):
    ...
    error_messages["password_incorrect"] = _("La contraseña actual es incorrecta.")
...
class RegisterForm(UserCreationForm):
    ...
    password1 = forms.CharField(
        ...
        strip=False,
        help_text=_(
            "Tu contraseña debe contener al menos 8 caracteres y no puede ser una contraseña común."
        ),
        widget=forms.PasswordInput(
            attrs={
                "class": "appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm",
